...
exports.postsCreateCommand = postsCreateCommand;
exports.postsListCommand = postsListCommand;
exports.postsApproveCommand = postsApproveCommand;
exports.postsGenerateCommand = postsGenerateCommand;
exports.postsCalendarCommand = postsCalendarCommand;
exports.postsViewCommand = postsViewCommand;
exports.postsCancelCommand = postsCancelCommand;
exports.postsRescheduleCommand = postsRescheduleCommand;
exports.postsDeleteCommand = postsDeleteCommand;
exports.postsGenerateBatchCommand = postsGenerateBatchCommand;
const client_1 = require("../client");
const config_1 = require("../config");
const VALID_PLATFORMS = ["x", "linkedin", "facebook", "instagram", "threads"];
async function postsCreateCommand(options) {
...
async function postsListCommand(options) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
...
async function postsApproveCommand(postId, options) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
...
async function postsGenerateCommand(options) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
    ...
    try {
        ...
        while (!finished && attempts < 60) {
            ...
            let opStatus = { status: "pending", progress: { message: "Queuing..." } };
            try {
                if (post.operationStatus)
                    opStatus = JSON.parse(post.operationStatus);
            }
            catch (e) { }
            if (opStatus.status === "completed") {
                ...
                try {
                    if (post.outputData)
                        outputData = JSON.parse(post.outputData);
                }
                catch (e) { }
...
async function postsCalendarCommand(options) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
...
async function postsViewCommand(postId) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
...
async function postsCancelCommand(postId) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
...
async function postsRescheduleCommand(postId, options) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
...
async function postsDeleteCommand(postId) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
...
async function postsGenerateBatchCommand(options) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
    ...
    const postTimes = options.times.split(",").map((t) => t.trim());
    ...
    if (options.voice)
        console.log(`   Voice ID: ${options.voice}`);
