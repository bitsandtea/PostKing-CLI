...
exports.socialCheckCommand = socialCheckCommand;
exports.socialConnectCommand = socialConnectCommand;
exports.socialDisconnectCommand = socialDisconnectCommand;
const client_1 = require("../client");
const config_1 = require("../config");
async function socialCheckCommand() {
...
async function socialConnectCommand() {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
...
async function socialDisconnectCommand(platformOrId) {
    const client = (0, client_1.createClient)();
    const brandId = (0, config_1.getBrandId)();
    if (!brandId) {
        console.error("ERROR: No active brand selected.");
    ...
    try {
        ...
        if (accountById) {
            ...
            const matchingAccounts = accounts.filter(a => a.platform.toLowerCase() === normalizedInput ||
